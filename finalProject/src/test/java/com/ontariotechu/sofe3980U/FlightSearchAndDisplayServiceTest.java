...
class FlightSearchAndDisplayServiceTest {
    ...
    @Mock
    private FlightSearch flightSearchMock;

    @Mock
    private FlightDisplay flightDisplayMock;

    @InjectMocks
    private FlightSearchAndDisplayService service;
    ...
    void testSearchAndDisplayFlightsIntegration() {
        ...
        when(flightSearchMock.getFlights(anyString(), anyString(), anyString(), anyString())).thenReturn(expectedFlights);
